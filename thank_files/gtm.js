...
"resource": {
  ...
  "rules":[
    [["if",0],["add",1,72,0,80,296,298,299,300,301,302,303,304,305,306,307,308,309,310,311,312,313,314,315,316,317,318,319,320,321,322,323,324,325,326,327,328,329,330,331,332,333,334,335,336,337,338,339,340,341,342,343,344,345,346,347,348,349,350,351,352,353,354,355,356,357,358,359,360,361,362,363,364,365,366,367,368,369,370,371,372,373,374,375,376,377,378,379,380,381,382,383,384,385,386,387,388,389,390,391,392,393,394,395,396,397,398,399,400,402,403,404,405,406,407,408,409,410,411,412,413,414,415,416,417,418,419,420,421,422,428,430,432,433,434,435,436,437,438,488]],
    [["if",1,2],["add",2,10,14,60,61,242,243,275,439,443,444,445,457,460,477,125]],
    ...
    [["if",1,2,34],["add",30]],
    [["if",2,19,35],["add",31]],
    [["if",1,2,36],["add",32,164,214]],
    [["if",1,2,37],["add",33]],
    [["if",0,37],["add",34]],
    [["if",0,34],["add",35]],
    [["if",1,2,38],["add",36,225]],
    [["if",7,39],["add",37]],
    [["if",2,40,41],["add",37]],
    [["if",2,19,42],["add",38]],
    [["if",7,43],["add",39]],
    [["if",2,19,44],["add",39,218]],
    [["if",2,19,45],["add",40,441]],
    [["if",1,2,46],["add",41,110]],
    [["if",7,47],["add",42]],
    [["if",2,19,48],["add",42,160,109]],
    [["if",0,49],["add",43]],
    [["if",0,50],["add",44,45]],
    [["if",0,51],["add",45]],
    [["if",0,44],["add",46]],
    ...
    [["if",1,2,57],["add",55]],
    [["if",2,19,58],["add",56]],
    [["if",1,2,59],["add",57,179]],
    [["if",0,59],["add",58]],
    [["if",0,55],["add",59]],
    [["if",60,61],["add",61,241,243,275,446,458,459,477]],
    [["if",0,56],["add",62]],
    [["if",0,62],["add",63]],
    [["if",0,63],["add",64]],
    [["if",1,2,64],["add",65]],
    ...
    [["if",28,37,76],["add",79]],
    [["if",0,16,19],["add",81]],
    [["if",0,16],["unless",77],["add",81]],
    [["if",28,78,79],["add",82]],
    [["if",28,79,80],["add",82]],
    [["if",28,81],["add",83]],
    [["if",28,67,82],["add",84]],
    [["if",28,67,83],["add",85,440]],
    [["if",28,67,84],["add",86,440]],
    [["if",28,67,85],["add",87,440]],
    [["if",28,33,67],["add",88,440]],
    [["if",0,86],["add",89]],
    [["if",87,88],["add",90]],
    [["if",1,2,89],["add",91]],
    [["if",0,90],["add",92]],
    ...
    [["if",1,2,96],["add",97]],
    [["if",0,97],["add",98]],
    [["if",2,19,98],["add",99,483]],
    [["if",27,28,99],["unless",100,101,102,103,104,105],["add",100]],
    [["if",27,28,102],["unless",99,100,101,103,104,105],["add",101]],
    [["if",27,28,103],["unless",99,100,101,102,104,105],["add",102]],
    [["if",27,28,104],["unless",99,100,101,102,103,105],["add",103]],
    [["if",27,28,105],["unless",99,100,101,102,103,104],["add",104]],
    [["if",27,28,100],["unless",99,101,102,103,104,105],["add",105]],
    [["if",27,28,101],["unless",99,100,102,103,104,105],["add",106]],
    [["if",1,2,106],["add",107,224]],
    [["if",0,106],["unless",1],["add",108]],
    [["if",1,2,107],["add",111]],
    [["if",0,108],["add",112]],
    [["if",1,2,109],["add",113]],
    [["if",1,2,110],["add",114]],
    ...
    [["if",28,132],["add",137]],
    [["if",1,2,133],["add",138]],
    [["if",1,2,134],["add",139,145,448,453]],
    [["if",4,135,136],["add",140]],
    [["if",28,137],["add",141]],
    [["if",4,138,139],["add",142,473]],
    [["if",0,140],["unless",141],["add",143]],
    [["if",28,140,142,143],["unless",144],["add",144]],
    [["if",28,145],["add",146]],
    [["if",28,146],["add",146]],
    [["if",4,147,148],["add",147]],
    [["if",4,149,150],["add",148]],
    [["if",4,151,152],["add",149]],
    [["if",4,153,154],["add",150]],
    [["if",0,155],["add",151]],
    [["if",0,156],["add",152]],
    [["if",0,157],["add",153]],
    [["if",0,158],["add",154]],
    [["if",159,160,161],["add",155]],
    [["if",1,2,162],["add",156]],
    [["if",0,162],["add",157]],
    [["if",2,19,163],["add",158]],
    [["if",0,163],["add",159]],
    [["if",0,67],["unless",1],["add",161]],
    [["if",164],["add",162]],
    [["if",165],["add",163]],
    [["if",1,2,166],["add",165]],
    [["if",0,167],["add",166]],
    [["if",4,168,169,170],["add",167,471]],
    [["if",4,171,172],["add",168]],
    [["if",28,173],["add",169]],
    [["if",28,174],["add",169]],
    [["if",4,175,176],["add",170]],
    [["if",4,177,178],["add",171]],
    [["if",4,179,180],["add",172]],
    [["if",4,181,182],["add",173]],
    [["if",4,183,184],["add",173]],
    [["if",1,2,67],["add",174,290,465]],
    [["if",0,67],["add",175]],
    [["if",1,2,140],["add",176]],
    [["if",4,185,186],["add",177]],
    [["if",4,187,188],["add",178]],
    [["if",1,2,189],["add",180]],
    [["if",0,189],["add",181]],
    [["if",2,190,191],["add",182]],
    [["if",0,191],["add",183]],
    [["if",0,65],["add",184,485,476]],
    [["if",28,192,193],["add",185]],
    [["if",28,194,195],["add",186]],
    [["if",28,195,196],["add",187]],
    [["if",28,195,197],["add",188]],
    [["if",28,195,198],["add",189]],
    [["if",28,195,199],["add",190]],
    [["if",1,2,200],["add",191]],
    [["if",0,200],["add",192]],
    [["if",1,2,201],["add",193]],
    [["if",0,16],["add",194]],
    ...
    [["if",0,209],["add",204]],
    [["if",1,2,210],["add",205]],
    [["if",1,2,211],["add",206,208]],
    [["if",0,56],["unless",1],["add",207]],
    [["if",1,2,129],["add",209,465,223,279,469]],
    [["if",1,2,212],["add",210]],
    [["if",0,213],["add",211]],
    [["if",0,214],["add",212]],
    [["if",1,2,214],["add",213,465,289]],
    [["if",1,2,215],["add",215]],
    [["if",1,2,216],["add",216]],
    [["if",1,2,217],["add",217]],
    [["if",1,2,218],["add",219]],
    ...
    [["if",1,2,221],["add",226]],
    [["if",1,2,222],["add",227]],
    [["if",4,223,224],["add",228]],
    [["if",1,2,225],["add",229]],
    [["if",1,2,226],["add",230]],
    [["if",226,227],["unless",1],["add",231]],
    [["if",1,2,228],["add",232]],
    [["if",0,228],["add",233]],
    [["if",28,229],["add",234]],
    [["if",28,199],["add",235]],
    [["if",28,230],["add",236]],
    [["if",28,231],["add",237]],
    [["if",28,232],["add",239,472]],
    [["if",1,2,233],["add",240]],
    [["if",28,171,234],["add",244]],
    [["if",0,235],["add",245]],
    [["if",1,2,236],["add",246]],
    [["if",28,237],["add",247]],
    [["if",28,238,239,240],["add",248]],
    [["if",242,243],["unless",241],["add",249]],
    [["if",242,244,246],["unless",245],["add",249]],
    [["if",28,240],["add",250,470]],
    [["if",4,247,248],["add",251,474]],
    [["if",28,249],["add",252]],
    [["if",88,111,238],["add",253]],
    [["if",28,250,251],["add",254,475]],
    [["if",252,253,254],["add",255]],
    [["if",28,252,255],["add",256]],
    [["if",28,252,256],["add",257]],
    [["if",28,252,257],["add",258]],
    [["if",28,252,258],["add",259]],
    [["if",28,252,259],["add",260]],
    [["if",28,252,260],["add",261]],
    [["if",252,253,261],["add",262]],
    [["if",252,253,262],["add",263]],
    [["if",252,253,263],["add",264]],
    [["if",252,253,264],["add",265]],
    [["if",252,253,265],["add",266]],
    [["if",252,253,266],["add",267]],
    [["if",252,253,267],["add",268]],
    [["if",252,253,268],["add",269]],
    [["if",252,253,269],["add",270]],
    [["if",60,270],["add",271]],
    [["if",60,271],["add",271]],
    [["if",60,272],["add",271]],
    [["if",60,273],["add",271]],
    ...
    [["if",0,277],["add",277]],
    [["if",1,2,277],["add",278]],
    [["if",28,244,278],["add",280]],
    [["if",28,244,279],["add",281]],
    [["if",28,244,280],["add",282]],
    [["if",28,244,281],["add",283]],
    [["if",28,244,282],["add",284,285]],
    [["if",1,2,283],["add",286]],
    [["if",1,2,67],["unless",284],["add",287]],
    [["if",1,276,285],["add",288]],
    [["if",1,2,286],["add",291,486,479]],
    [["if",3,4,287],["add",292]],
    [["if",0,45],["add",293]],
    [["if",0,19,288],["add",294]],
    [["if",0],["unless",3],["add",295]],
    [["if",0,289],["add",297]],
    [["if",290],["add",401,431]],
    [["if",0,252],["add",423]],
    [["if",0,291],["add",424]],
    [["if",0],["unless",292],["add",425,426,427]],
    [["if",0],["unless",1],["add",429,446]],
    [["if",1,2,50],["add",442]],
    [["if",0,98],["add",447,484]],
    [["if",0],["unless",293],["add",449]],
    [["if",0],["unless",294],["add",449]],
    [["if",0,295],["add",450,451]],
    [["if",0,296],["add",452]],
    [["if",0,1],["add",454]],
    [["if",87,88,244],["add",455]],
    [["if",244,253,298],["add",456]],
    [["if",0,300,301],["add",461,462]],
    [["if",2,19,300],["add",463,464]],
    [["if",1,2,302],["add",465]],
    [["if",1,286,303],["add",465]],
    [["if",286,304,305],["add",466]],
    [["if",0,244],["add",476]],
    [["if",28,306],["add",478]],
    [["if",28,307],["unless",308],["add",480]],
    [["if",2,19,299,309,310],["add",481]],
    [["if",2,19,299,311],["unless",312],["add",482]],
    [["if",0,19,313],["add",487]],
    [["if",0,297],["block",454]],
    [["if",2,299],["block",460]]]
},
...
Z.b.fls=[],function(){function a(b,c){c=c?c.slice(0,-1):void 0;pm(b,c)}(function(b){Z.__fls=b;Z.__fls.g="fls";Z.__fls.h=!0;Z.__fls.priorityOverride=0})(function(b){var c;if(b.vtp_enableProductReporting){var d=function(t){t=t||[];for(var q=[],v=[["i","id"],["p","price"],["q","quantity"],["c","country"],["l","language"],["a","accountId"]],u=0;u<t.length;u++)for(var w=0;w<v.length;w++){var y=v[w],x=t[u][y[1]];void 0!==x&&q.push(y[0]+
(u+1)+":"+X(x))}return q.join("|")};switch(b.vtp_dataSource){case "DATA_LAYER":c=d(Cp("ecommerce.purchase.products"));break;case "JSON":c=d(b.vtp_productData);break;case "STRING":for(var e=(b.vtp_productData||"").split("|"),f=0;f<e.length;f++){var g=e[f].split(":");g[1]=g[1]&&X(g[1])||"";e[f]=g.join(":")}c=e.join("|")}}var h=!b.hasOwnProperty("vtp_enableConversionLinker")||b.vtp_enableConversionLinker,l=sq(b.vtp_customVariable||
[],"key","value")||{},m={yb:b.vtp_activityTag,jd:h,Ta:b.vtp_conversionCookiePrefix||void 0,jc:b.vtp_revenue,aa:"ITEM_SOLD"===b.vtp_countingMethod?6:5,kd:b.vtp_advertiserId,nd:b.vtp_groupTag,H:b.vtp_gtmOnFailure,I:b.vtp_gtmOnSuccess,wc:b.vtp_useImageTag?void 0:b.vtp_url,Bd:c,protocol:"",Fd:b.vtp_quantity,Id:!b.vtp_useImageTag,Ec:b.vtp_transactionVariable,transactionId:b.vtp_orderId,Fc:b.vtp_userVariable,Md:l},n=!jg(I.o)&&void 0!=Cp(I.N)&&!1!==Cp(I.N);m.Hb=n;if(b.vtp_enableAttribution){var r=b.vtp_attributionFields||
[];if(r.length){S("//www.gstatic.com/attribution/collection/attributiontools.js",function(){a(m,W("google_attr").build([sq(r,"key","value")||{}]))},b.vtp_gtmOnFailure);return}}a(m)})}();
...
!0,S(u,f(),e(u)))})}();Z.b.logging=["google"],function(){function a(){return{}}(function(b){Z.__logging=b;Z.__logging.g="logging";Z.__logging.h=!0;Z.__logging.priorityOverride=0})(function(b){var c=b.vtp_environments||"debug",d=b.vtp_createPermissionError;return{assert:function(e){if("all"!==c&&!oq.xh())throw d(e,{},"Logging is not enabled in all environments");},K:a}})}();
